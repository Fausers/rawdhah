 ...
 <!-- .page-title start -->
        <div class="page-title-style01 page-title-negative-top pt-bkg07">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 style="color: yellow">Services - Project Logistics</h1>
                        ...
                        <div class="breadcrumb-container">
                            <ul class="breadcrumb clearfix">
                                ...
                                <li>
                                    <a href="{{route('large_projects')}}" style="color: yellow">Large Projects</a>
                                </li>
                    ...
                    <div class="col-md-9">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <p>
                                    The Rawdhar provides a full range of Logistics and transportation services for 
                                    delivery of various types of heavy machine, construction, road, and agricultural 
                                    machinery such as generators, lifts, winches, jacks from sea port to the customer destination.
                                </p>

                                <p>
                                    In the transportation market there is stable upward trend, mostly of large industrial 
                                    enterprises boost production volumes, open up new markets and increase import and export
                                    volumes. At Rawdhar Haulages has mastered the challenge of providing tailored customer 
                                    service in rapidly developing market segment by creating the dedicating logistics division.
                                </p>
                            </div><!-- .col-md-12 end -->
                        </div><!-- .row end -->
